...
function switchPlayers(player)
{
	...
	document.getElementById("avg_p_yards").innerHTML = Math.round(players[player].pass_yards/players[player].games_played)
	document.getElementById("avg_r_yards").innerHTML = Math.round(players[player].rushing_yards/players[player].games_played)
	document.getElementById("avg_rec_yards").innerHTML = Math.round(players[player].receiving_yards/players[player].games_played)
}
